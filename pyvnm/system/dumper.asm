        ORG     0xf0            @ carrega dumper após o loader
MAIN    LD      MEM_START       @ carrega posição inicial proveniente do loader
        ...
        LD      0xc6            @ carrega número de bytes proveniente do loader
        ...
        LD      0xc8            @ carrega posição inicial proveninete do loader
...
INC_CHECKSUM                    @ subrotina: inc. checksum sem causar side-effect
        ...
        RS      INC_CHECKSUM
MEM_START       DATA    0xc6    @ endereço onde o loader armazena a posição inicial do programa carregado
N_BYTES         DATA    0xc8    @ endereço onde o loader armazena a quantidade de bytes do programa
