...
LOOP    SC      WRITE_BYTES     @ inicia o loop de escrita no disco
        ...
        LD      BYTES_RESTANTES @ carrega contador de bytes restantes
        SB      NUM_2           @ decrementa uma unidade do contador
        ST      BYTES_RESTANTES @ armazena novo valor do contador na memória
...
WRITE_BYTES                     @ subrotina: escreve uma palavra no disco
        SC      INC_CHECKSUM    @ incrementa o checksum com a inst carregada
